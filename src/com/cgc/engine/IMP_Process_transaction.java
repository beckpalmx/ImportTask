...
public class IMP_Process_transaction {
    ...
    public String main_check(String doc_date_from, String doc_date_to, String username, String process_for) throws Exception {
        Connection Conn = new DBConnect().openTestConnection();
        ...
        try {
            ...
            String Insert_Log = "insert into t_process_log (log_id,process_id,start_time,end_time,create_date,create_by,complete_flag,remark) values (?,?,?,?,?,?,?,?) ";
            ...
            p_log.setString(7, "Y");
            p_log.setString(8, InetAddress.getLocalHost().getHostAddress());
            p_log.executeUpdate();
